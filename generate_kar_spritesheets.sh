#!/bin/bash
# Generate spritesheet configuration files for kar9 through kar69

SPRITE_DIR="/Users/kang/GitHub/ai-twon-exp-3/data/spritesheets"

for i in {9..69}; do
  cat > "${SPRITE_DIR}/kar${i}.ts" << 'INNEREOF'
...
INNEREOF
  echo "Created kar${i}.ts"
done

echo "✅ Created spritesheet files for kar9 through kar69"
